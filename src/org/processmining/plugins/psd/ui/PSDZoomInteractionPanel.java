...
public class PSDZoomInteractionPanel extends JPanel implements ViewInteractionPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2776308997217603201L;
	...
	private boolean isChangingVisibility = false;

	public PSDZoomInteractionPanel(ScalableViewPanel panel, PSDVisualizer root, int maximumZoom) {
	...
	public void willChangeVisibility(boolean to) {
		...
		setValue((int) Math.round(100 * scalable.getScale()));
